...
xyz = FK(robot, deg2rad(goal_locs.red_1x2.pick.down));
...
xyz = FK(robot, deg2rad(goal_locs.red_1x8.pick.down));
...
xyz = FK(robot, deg2rad(goal_locs.red_1x8.drop.down));
...
xyz = FK(robot, deg2rad(goal_locs.red_2x6.pick.down));
...
xyz = FK(robot, deg2rad(goal_locs.red_2x6.drop.down));
...
xyz = FK(robot, deg2rad(goal_locs.orange_1x2.pick.down));
...
xyz = FK(robot, deg2rad(goal_locs.orange_1x2.drop.down));
